...
import io.swagger.client.model.BoardInfo;
...
public class DefaultApi {
   ...
   */
  public BoardInfo boardEventsGet() throws ApiException {
    Object localVarPostBody = null;
    
    // create path and map variables
    String localVarPath = "/board-events".replaceAll("\\{format\\}","json");
    ...
    GenericType<BoardInfo> localVarReturnType = new GenericType<BoardInfo>() {};
   ...
   * @throws ApiException if fails to make API call
   */
  public BoardInfo boardInfoGet() throws ApiException {
    Object localVarPostBody = null;
    
    // create path and map variables
    String localVarPath = "/board-info".replaceAll("\\{format\\}","json");
