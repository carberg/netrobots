...
module SwaggerClient
  ...
  class RobotConfiguration
    ...
    def hash
      [name, max_hit_points, max_speed, acceleration, decelleration, max_sterling_speed, max_scan_distance, max_fire_distance, bullet_speed, bullet_damage, cannon_reloading_time].hash
    end
