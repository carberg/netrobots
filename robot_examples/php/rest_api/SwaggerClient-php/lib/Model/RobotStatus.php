...
class RobotStatus implements ArrayAccess
{
    ...
    /**
      * $is_dead True if the robot is dead, or if during initial creation params are out of range.
      * @var bool
      */
    protected $is_dead;
    ...
    /**
     * Sets points
     * @param float $points The sum of all hit points of the fired missiles. The robot with more hit points is the winner.
     * @return $this
     */
    ...
    /**
     * Sets is_dead
     * @param bool $is_dead True if the robot is dead, or if during initial creation params are out of range.
     * @return $this
     */
