...
var _user$project$BoardViewer$viewStreaming = function (model) {
	...
	var completitionPerc = function (isPrestreaming) {
		if (isPrestreaming) {
			return A3(calcPerc, model.preStreaming, 3.0, 33);
		} else {
			var preStreamingPerc = completitionPerc(true);
			var leftPerc = 100.0 - preStreamingPerc;
			var streamingPerc = A3(calcPerc, model.streamingTot - model.streamingLeft, model.streamingTot, leftPerc);
			return streamingPerc + preStreamingPerc;
		}
	};
	var perc = A2(
...
var _user$project$BoardViewer$tankSymbolDef = A2(
	...
	_elm_lang$core$Native_List.fromArray(
		[
			...
			_elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$svg$Svg_Attributes$transform('matrix(1.8,0,0,1.8,-108.63617,-967.4266)'),
					_elm_lang$svg$Svg_Attributes$id('tank')
				]),
			_elm_lang$core$Native_List.fromArray(
				[
					...
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$svg$Svg_Attributes$d('m 290.61109,594.7957 -70.62176,0 -21.67599,-11.65375 0,-32.8636 138.91278,-12.81913 0,42.88583 -46.61503,9.08992 0,5.36073 z'),
							_elm_lang$svg$Svg_Attributes$id('path5534')
						]),
					_elm_lang$core$Native_List.fromArray(
						[])),
					A2(
					...
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$svg$Svg_Attributes$d('m 65.22745,640.14176 318.38061,0.56974 -0.0533,-59.20108 -91.31212,20.04446 -132.85282,0 -94.16235,25.17211 c -5.54704,2.24346 -7.3857,13.41477 0,13.41477 z'),
							_elm_lang$svg$Svg_Attributes$style('display:inline;overflow:visible;visibility:visible;fill-opacity:1;fill-rule:nonzero;stroke:none;stroke-width:1;stroke-linecap:round;stroke-linejoin:miter;stroke-miterlimit:4;stroke-dasharray:none;stroke-dashoffset:0;stroke-opacity:1;marker:none;marker-start:none;marker-mid:none;marker-end:none'),
							_elm_lang$svg$Svg_Attributes$id('path5536')
						]),
					_elm_lang$core$Native_List.fromArray(
						[])),
					A2(
					...
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$svg$Svg_Attributes$d('m 155.81493,666.86299 c -3e-5,11.30705 -9.15117,20.48115 -20.45818,20.50952 -11.30701,0.0284 -20.50407,-9.09969 -20.56084,-20.4066 -0.0568,-11.3069 9.04816,-20.52686 20.35489,-20.61203 11.30672,-0.0852 20.54952,8.99658 20.66309,20.30305'),
							_elm_lang$svg$Svg_Attributes$style('fill-opacity:1;fill-rule:evenodd;stroke:none;stroke-width:1px;stroke-linecap:butt;stroke-linejoin:miter;stroke-opacity:1'),
							_elm_lang$svg$Svg_Attributes$id('path1874')
						]),
					_elm_lang$core$Native_List.fromArray(
						[])),
					A2(
					...
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$svg$Svg_Attributes$d('m 201.97733,666.86299 c -3e-5,11.30705 -9.15117,20.48115 -20.45818,20.50952 -11.30701,0.0284 -20.50407,-9.09969 -20.56084,-20.4066 -0.0568,-11.3069 9.04816,-20.52686 20.35489,-20.61203 11.30672,-0.0852 20.54952,8.99658 20.66309,20.30305'),
							_elm_lang$svg$Svg_Attributes$style('fill-opacity:1;fill-rule:evenodd;stroke:none;stroke-width:1px;stroke-linecap:butt;stroke-linejoin:miter;stroke-opacity:1'),
							_elm_lang$svg$Svg_Attributes$id('path1876')
						]),
					_elm_lang$core$Native_List.fromArray(
						[])),
					A2(
					...
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$svg$Svg_Attributes$d('m 247.33033,666.86299 c -3e-5,11.30705 -9.15117,20.48115 -20.45818,20.50952 -11.30701,0.0284 -20.50407,-9.09969 -20.56084,-20.4066 -0.0568,-11.3069 9.04816,-20.52686 20.35489,-20.61203 11.30672,-0.0852 20.54952,8.99658 20.66309,20.30305'),
							_elm_lang$svg$Svg_Attributes$style('fill-opacity:1;fill-rule:evenodd;stroke:none;stroke-width:1px;stroke-linecap:butt;stroke-linejoin:miter;stroke-opacity:1'),
							_elm_lang$svg$Svg_Attributes$id('path1880')
						]),
					_elm_lang$core$Native_List.fromArray(
						[])),
					A2(
					...
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$svg$Svg_Attributes$d('m 293.76333,666.86299 c -3e-5,11.30705 -9.15117,20.48115 -20.45818,20.50952 -11.30701,0.0284 -20.50407,-9.09969 -20.56084,-20.4066 -0.0568,-11.3069 9.04816,-20.52686 20.35489,-20.61203 11.30672,-0.0852 20.54952,8.99658 20.66309,20.30305'),
							_elm_lang$svg$Svg_Attributes$style('fill-opacity:1;fill-rule:evenodd;stroke:none;stroke-width:1px;stroke-linecap:butt;stroke-linejoin:miter;stroke-opacity:1'),
							_elm_lang$svg$Svg_Attributes$id('path3511')
						]),
					_elm_lang$core$Native_List.fromArray(
						[])),
					A2(
					...
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$svg$Svg_Attributes$d('m 339.83623,667.93559 c -3e-5,11.30705 -9.15117,20.48115 -20.45818,20.50952 -11.30701,0.0284 -20.50407,-9.09969 -20.56084,-20.4066 -0.0568,-11.3069 9.04816,-20.52686 20.35489,-20.61203 11.30672,-0.0852 20.54952,8.99658 20.66309,20.30305'),
							_elm_lang$svg$Svg_Attributes$style('fill-opacity:1;fill-rule:evenodd;stroke:none;stroke-width:1px;stroke-linecap:butt;stroke-linejoin:miter;stroke-opacity:1'),
							_elm_lang$svg$Svg_Attributes$id('path1884')
						]),
					_elm_lang$core$Native_List.fromArray(
						[])),
					A2(
					...
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$svg$Svg_Attributes$d('m 368.27196,658.40424 c -2e-5,6.44528 -5.21638,11.67474 -11.66165,11.69091 -6.44527,0.0162 -11.68781,-5.18704 -11.72017,-11.63225 -0.0324,-6.4452 5.15767,-11.7008 11.60277,-11.74935 6.44511,-0.0486 11.71372,5.12827 11.77846,11.57323'),
							_elm_lang$svg$Svg_Attributes$style('fill-opacity:1;fill-rule:evenodd;stroke:none;stroke-width:1px;stroke-linecap:butt;stroke-linejoin:miter;stroke-opacity:1'),
							_elm_lang$svg$Svg_Attributes$id('path1886')
						]),
					_elm_lang$core$Native_List.fromArray(
						[])),
					A2(
					...
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$svg$Svg_Attributes$d('m 110.01126,658.40424 c -2e-5,6.44528 -5.21638,11.67474 -11.66165,11.69091 -6.44527,0.0162 -11.68781,-5.18704 -11.72017,-11.63225 -0.03236,-6.4452 5.15767,-11.7008 11.60277,-11.74935 6.44511,-0.0486 11.71372,5.12827 11.77846,11.57323'),
							_elm_lang$svg$Svg_Attributes$style('fill-opacity:1;fill-rule:evenodd;stroke:none;stroke-width:1px;stroke-linecap:butt;stroke-linejoin:miter;stroke-opacity:1'),
							_elm_lang$svg$Svg_Attributes$id('path1888')
						]),
					_elm_lang$core$Native_List.fromArray(
						[]))
				]))
					...
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								...
								_elm_lang$core$Native_List.fromArray(
									[
										_elm_lang$svg$Svg$text('Server Property')
									])),
								A2(
								_debois$elm_mdl$Material_Table$th,
								_elm_lang$core$Native_List.fromArray(
					...
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								...
								_elm_lang$core$Native_List.fromArray(
									[
										_elm_lang$svg$Svg$text('Game Board dim.')
									])),
								A2(
								_debois$elm_mdl$Material_Table$td,
								_elm_lang$core$Native_List.fromArray(
								...
								_elm_lang$core$Native_List.fromArray(
									[
										...
										A2(
											_elm_lang$core$Basics_ops['++'],
											_user$project$BoardViewer$niceFloat(bi.maxBoardX),
											A2(
												_elm_lang$core$Basics_ops['++'],
												' x ',
												_user$project$BoardViewer$niceFloat(bi.maxBoardY))))
									]))
							])),
						A2(
						_debois$elm_mdl$Material_Table$tr,
						...
						_elm_lang$core$Native_List.fromArray(
							[
								...
								_elm_lang$core$Native_List.fromArray(
									[
										_elm_lang$svg$Svg$text('Robot moves for each second')
									])),
								A2(
								_debois$elm_mdl$Material_Table$td,
								_elm_lang$core$Native_List.fromArray(
								...
								_elm_lang$core$Native_List.fromArray(
									[
										_elm_lang$svg$Svg$text(
										_elm_lang$core$Basics$toString(1.0 / bi.turnDeltaTime))
									]))
							])),
						A2(
						_debois$elm_mdl$Material_Table$tr,
						...
						_elm_lang$core$Native_List.fromArray(
							[
								...
								_elm_lang$core$Native_List.fromArray(
									[
										_elm_lang$svg$Svg$text('Virtual simulated seconds')
									])),
								A2(
								_debois$elm_mdl$Material_Table$td,
								_elm_lang$core$Native_List.fromArray(
								...
								_elm_lang$core$Native_List.fromArray(
									[
										_elm_lang$svg$Svg$text(
										_user$project$BoardViewer$niceFloat(model.currentSimulationTime))
									]))
							])),
						A2(
						_debois$elm_mdl$Material_Table$tr,
						...
						_elm_lang$core$Native_List.fromArray(
							[
								...
								_elm_lang$core$Native_List.fromArray(
									[
										_elm_lang$svg$Svg$text('Max network latency (in seconds))')
									])),
								A2(
								_debois$elm_mdl$Material_Table$td,
								_elm_lang$core$Native_List.fromArray(
								...
								_elm_lang$core$Native_List.fromArray(
									[
										_elm_lang$svg$Svg$text(
										_elm_lang$core$Basics$toString(bi.networkLatency))
									]))
							])),
						A2(
						_debois$elm_mdl$Material_Table$tr,
						...
						_elm_lang$core$Native_List.fromArray(
							[
								...
								_elm_lang$core$Native_List.fromArray(
									[
										_elm_lang$svg$Svg$text('Frame per Second')
									])),
								A2(
								_debois$elm_mdl$Material_Table$td,
								_elm_lang$core$Native_List.fromArray(
								...
								_elm_lang$core$Native_List.fromArray(
									[
										_elm_lang$svg$Svg$text(
										_user$project$BoardViewer$niceFloat(fps))
									]))
							]))
					]))
			]));
...
var _user$project$BoardViewer$viewBoard = function (model) {
		...
		function (results1, be) {
			...
			switch (_p15.ctor) {
				case 'EDisplayMissile':
					return A2(
						_elm_lang$core$List_ops['::'],
						A2(drawMissile, be.activationTime, _p15._0),
						results1);
				case 'EDisplayRobot':
					return A2(
						_elm_lang$core$List_ops['::'],
				...
				case 'EDisplayScan':
					return A2(
						_elm_lang$core$List_ops['::'],
						A2(drawScan, be.activationTime, _p15._0),
						results1);
				case 'EDisplayTrack':
					return A2(
						_elm_lang$core$List_ops['::'],
						A2(drawTrack, be.activationTime, _p15._0),
						results1);
				case 'EDisplayExplosion':
					return A2(
						_elm_lang$core$List_ops['::'],
						A2(drawExplosion, be.activationTime, _p15._0),
						results1);
				case 'EDisplayLostPoints':
					return A2(
						_elm_lang$core$List_ops['::'],
						A2(drawLostPoints, be.activationTime, _p15._0),
						results1);
				default:
					return results1;
			}
	...
	var boardMaxY = boardInfo.maxBoardY;
	var drawBoardPerimeter = A2(
		_elm_lang$svg$Svg$rect,
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$svg$Svg_Attributes$width(
	...
	var containerCssStyle = _elm_lang$html$Html_Attributes$style(
		_elm_lang$core$Native_List.fromArray(
			[
				...
				{ctor: '_Tuple2', _0: 'flex-flow', _1: 'row'},
				{ctor: '_Tuple2', _0: 'flex-grow', _1: '0'},
			...
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_user$project$BoardViewer$viewBoard(model))
					])),
				A2(
				_elm_lang$html$Html$div,
				_elm_lang$core$Native_List.fromArray(
...
var _user$project$BoardViewer$polarToCartesian = F4(
	function (centerX, centerY, radius, angleInRadians) {
		var _p21 = _elm_lang$core$Basics$fromPolar(
...
var _user$project$BoardViewer$BoardInfo = F8(
	function (a, b, c, d, e, f, g, h) {
...
var _user$project$BoardViewer$robotInfoDecoder = function () {
	var part2 = function (_p22) {
		var _p23 = _p22;
		return A6(
			_elm_lang$core$Json_Decode$object5,
			A6(_user$project$BoardViewer$RobotInfo, _p23._0, _p23._1, _p23._2, _p23._3, _p23._4, _p23._5),
...
var _user$project$BoardViewer$BoardEvent = F2(
	function (a, b) {
		return {event: a, activationTime: b};
	});
var _user$project$BoardViewer$EventCreateRobot = F3(
	function (a, b, c) {
		return {robot: a, name: b, color: c};
	});
var _user$project$BoardViewer$eventCreateRobotDecoder = A4(
	_elm_lang$core$Json_Decode$object3,
	_user$project$BoardViewer$EventCreateRobot,
	A2(_elm_lang$core$Json_Decode_ops[':='], 'robot', _user$project$BoardViewer$robotInfoDecoder),
	A2(_elm_lang$core$Json_Decode_ops[':='], 'name', _user$project$BoardViewer$jstring),
	A2(_elm_lang$core$Json_Decode_ops[':='], 'color', _user$project$BoardViewer$jstring));
var _user$project$BoardViewer$EventRemoveRobot = function (a) {
	return {robot: a};
};
var _user$project$BoardViewer$eventRemoveRobotDecoder = A2(
...
var _user$project$BoardViewer$eventScanDecoder = A6(
	_elm_lang$core$Json_Decode$object5,
	_user$project$BoardViewer$EventScan,
	A2(_elm_lang$core$Json_Decode_ops[':='], 'direction', _elm_lang$core$Json_Decode$float),
	A2(_elm_lang$core$Json_Decode_ops[':='], 'semiaperture', _elm_lang$core$Json_Decode$float),
	A2(_elm_lang$core$Json_Decode_ops[':='], 'scanMaxDistance', _elm_lang$core$Json_Decode$float),
	A2(_elm_lang$core$Json_Decode_ops[':='], 'robot', _user$project$BoardViewer$robotInfoDecoder),
	_elm_lang$core$Json_Decode$maybe(
...
var _user$project$BoardViewer$eventMissileDecoder = A5(
	_elm_lang$core$Json_Decode$object4,
	_user$project$BoardViewer$EventMissile,
	A2(_elm_lang$core$Json_Decode_ops[':='], 'robot', _user$project$BoardViewer$robotInfoDecoder),
	A2(_elm_lang$core$Json_Decode_ops[':='], 'direction', _elm_lang$core$Json_Decode$float),
...
var _user$project$BoardViewer$eventExplosionDecoder = A4(
	_elm_lang$core$Json_Decode$object3,
...
var _user$project$BoardViewer$eventRobotCollisionDecoder = A2(
	_elm_lang$core$Json_Decode$object1,
	_user$project$BoardViewer$EventRobotCollision,
	A2(_elm_lang$core$Json_Decode_ops[':='], 'robot', _user$project$BoardViewer$robotInfoDecoder));
var _user$project$BoardViewer$EventDrive = function (a) {
	return {robot: a};
};
var _user$project$BoardViewer$eventDriveDecoder = A2(
	_elm_lang$core$Json_Decode$object1,
	_user$project$BoardViewer$EventDrive,
	A2(_elm_lang$core$Json_Decode_ops[':='], 'robot', _user$project$BoardViewer$robotInfoDecoder));
var _user$project$BoardViewer$Model = function (a) {
	return function (b) {
		return function (c) {
			return function (d) {
				return function (e) {
												...
												return function (m) {
													return function (n) {
														return function (o) {
															return function (p) {
																return function (q) {
																	return {isInitializated: a, windowSize: b, preStreaming: c, streamingTot: d, streamingLeft: e, simulationIsStarted: f, boardInfo: g, streamedBoardInfo: h, nextEvents: i, activeEvents: j, robotInfo: k, usedRobotColors: l, currentSimulationTime: m, errorMessages: n, totRedrawFrames: o, totSeconds: p, mdl: q};
																};
															};
														};
													};
...
var _user$project$BoardViewer$model_processEvent = F2(
	function (m1, be) {
		var initActiveScan = function (scan) {
			...
			var startAngleRad = _p24._0;
			var endAngleRad = _p24._1;
			var centerY = scan.robot.posY;
			var centerX = scan.robot.posX;
			var _p25 = function () {
				var _p26 = scan.hitRobot;
				if (_p26.ctor === 'Nothing') {
					...
					return {
						ctor: '_Tuple4',
						_0: true,
						_1: A4(_user$project$BoardViewer$distanceXYXY, centerX, centerY, _p27.posX, _p27.posY),
						_2: _p27.posX,
						_3: _p27.posY
					};
				}
			}();
			var hasRecognizedSomething = _p25._0;
			var distance = _p25._1;
			var targetX = _p25._2;
			var targetY = _p25._3;
			var isLimitCase = _elm_lang$core$Native_Utils.cmp(distance, 0.1) < 1;
			var targetLineColor = hasRecognizedSomething ? 'red' : 'blue';
			var _p28 = A4(_user$project$BoardViewer$polarToCartesian, centerX, centerY, distance, startAngleRad);
			var startX = _p28._0;
			var startY = _p28._1;
			var _p29 = A4(_user$project$BoardViewer$polarToCartesian, centerX, centerY, distance, endAngleRad);
			var endX = _p29._0;
			var endY = _p29._1;
			var _p30 = A4(_user$project$BoardViewer$polarToCartesian, centerX, centerY, distance, directionRad);
			var directionX = _p30._0;
			var directionY = _p30._1;
		...
		var robotInfo = function (robotId) {
			var _p31 = A2(_elm_lang$core$Dict$get, robotId, m1.robotInfo);
		...
		var updateMaybeRobot = F2(
			function (m, mr) {
				var _p34 = mr;
				if (_p34.ctor === 'Just') {
					return A2(updateRobot, m, _p34._0);
				} else {
					return m;
				}
			});
		...
		switch (_p35.ctor) {
				...
				return _elm_lang$core$Native_Utils.update(
					m1,
					{
						robotInfo: A3(
							_elm_lang$core$Dict$insert,
							_p36.robot.robotId,
							{ctor: '_Tuple2', _0: be.activationTime, _1: _p36},
							m1.robotInfo),
						usedRobotColors: A3(
							_elm_lang$core$Dict$insert,
							_p36.color,
			...
			case 'ERemoveRobot':
				return _elm_lang$core$Native_Utils.update(
					m1,
					{
						robotInfo: A2(_elm_lang$core$Dict$remove, _p35._0.robot.robotId, m1.robotInfo)
					});
			case 'EDrive':
				return A2(updateRobot, m1, _p35._0.robot);
			case 'EScan':
				var _p37 = _p35._0;
				return A2(
					addActiveEvent,
			...
			case 'EMissile':
				...
				return A2(
					addActiveEvent,
					A2(updateRobot, m1, _p38.robot),
					_user$project$BoardViewer$EDisplayMissile(
						initActiveMissile(_p38)));
			case 'EDisplayMissile':
				var _p39 = _p35._0;
				return (_elm_lang$core$Native_Utils.cmp(_p39.deactivationTime, currentTime) < 1) ? A2(
					addActiveEvent,
					m1,
					_user$project$BoardViewer$EDisplayExplosion(
						initActiveExplosion(_p39))) : A2(
					addActiveEvent,
					m1,
					_user$project$BoardViewer$EDisplayMissile(
						updateActiveMissile(_p39)));
			case 'EDisplayExplosion':
				return (_elm_lang$core$Native_Utils.cmp(_p35._0.deactivationTime, currentTime) < 1) ? m1 : A2(addActiveBoardEvent, m1, be);
			case 'EDisplayTrack':
				return (_elm_lang$core$Native_Utils.cmp(_p35._0.deactivationTime, currentTime) < 1) ? m1 : A2(addActiveBoardEvent, m1, be);
			case 'EDisplayLostPoints':
				return (_elm_lang$core$Native_Utils.cmp(_p35._0.deactivationTime, currentTime) < 1) ? m1 : A2(addActiveBoardEvent, m1, be);
			case 'EExplosion':
				var _p40 = _p35._0;
				var m2 = A2(updateRobot, m1, _p40.robot);
				var m3 = A2(updateRobot, m2, _p40.hitRobot);
				var m4 = A2(
					addActiveEvent,
					m3,
					_user$project$BoardViewer$EDisplayLostPoints(
						initActiveLostPoints(_p40)));
				return m4;
...
var _user$project$BoardViewer$model_processNextEvents = function (m1) {
	...
	while (true) {
		var _p42 = m1.boardInfo;
		if (_p42.ctor === 'Nothing') {
			return m1;
		} else {
			var _p43 = _elm_lang$core$List$head(m1.nextEvents);
			if (_p43.ctor === 'Nothing') {
				var _p44 = _elm_lang$core$Native_Utils.cmp(m1.currentSimulationTime, _p42._0.endTime) > 0;
				if (_p44 === true) {
					var _p45 = _user$project$BoardViewer$model_loadStreamedData(
						_elm_lang$core$Native_Utils.update(
							m1,
				...
				var _p48 = _p43._0;
				var _p46 = _elm_lang$core$Native_Utils.cmp(_p48.activationTime, m1.currentSimulationTime) < 1;
				if (_p46 === false) {
					return m1;
				} else {
					var m2 = _elm_lang$core$Native_Utils.update(
						...
						{
							nextEvents: function () {
								var _p47 = _elm_lang$core$List$tail(m1.nextEvents);
					...
					var m3 = A2(_user$project$BoardViewer$model_processEvent, m2, _p48);
					var _v24 = m3;
					m1 = _v24;
					continue model_processNextEvents;
				}
...
var _user$project$BoardViewer$model_addRobotEvents = function (model) {
	...
	var processRobot = function (_p49) {
		var _p50 = _p49;
		var _p52 = _p50._1;
		var direction = _p52.robot.direction;
		...
		var robotInfo = _p52.robot;
		var deltaTimeToRequiredSpeed = (_p52.robot.requiredSpeed - _p52.robot.currentSpeed) / _p52.robot.acceleration;
		var deltaTime = simulationTime - _p50._0;
		var _p51 = (_elm_lang$core$Native_Utils.cmp(deltaTime, deltaTimeToRequiredSpeed) > 0) ? {ctor: '_Tuple3', _0: deltaTimeToRequiredSpeed, _1: deltaTime - deltaTimeToRequiredSpeed, _2: 0.0} : {ctor: '_Tuple3', _0: deltaTime, _1: 0, _2: _p52.robot.acceleration};
		var deltaTimeWithNormalAcceleration = _p51._0;
		var deltaTimeWithMaxSpeed = _p51._1;
		var currentAcceleration = _p51._2;
		var movement1 = (_p52.robot.currentSpeed * deltaTimeWithNormalAcceleration) + ((0.5 * _p52.robot.acceleration) * (deltaTimeWithNormalAcceleration * deltaTimeWithNormalAcceleration));
		var movement2 = _p52.robot.requiredSpeed * deltaTimeWithMaxSpeed;
		var movement = movement1 + movement2;
		var dy = movement * _elm_lang$core$Basics$sin(
			_elm_lang$core$Basics$degrees(_p52.robot.direction));
		var posY = _p52.robot.posY + dy;
		var dx = movement * _elm_lang$core$Basics$cos(
			_elm_lang$core$Basics$degrees(_p52.robot.direction));
		var posX = _p52.robot.posX + dx;
		var track = {
			...
			lineCords: _elm_lang$core$Native_List.fromArray(
				[
					...
					_elm_lang$svg$Svg_Attributes$stroke(_p52.color)
				])
		};
		var reloadingTime1 = _p52.robot.reloadingTime - deltaTime;
	...
	var finalEvents = A3(
		_elm_lang$core$Dict$foldl,
		F3(
			function (_p54, _p53, events1) {
				var _p55 = _p53;
				var _p58 = _p55._0;
				var deltaTime = simulationTime - _p58;
				var _p56 = processRobot(
					{ctor: '_Tuple2', _0: _p58, _1: _p55._1});
				var robotEvent = _p56._0;
				var activeTrack = _p56._1;
				var events2 = function () {
					var _p57 = isTimeToLeaveTheTrack(deltaTime);
					if (_p57 === true) {
						return A2(
							_elm_lang$core$List_ops['::'],
							{
				...
				var events3 = A2(
					_elm_lang$core$List_ops['::'],
					{activationTime: _p58, event: robotEvent},
					events2);
				return events3;
			}),
		model.activeEvents,
...
var _user$project$BoardViewer$model_processAllEvents = F2(
	function (m1, deltaRealTimeSeconds) {
		var _p59 = m1.boardInfo;
		if (_p59.ctor === 'Nothing') {
			return m1;
		} else {
			var deltaTime = A2(_user$project$BoardViewer$boardInfo_fromRealTimeToSimulatedTime, _p59._0, deltaRealTimeSeconds);
			var m2 = _elm_lang$core$Native_Utils.update(
				m1,
...
var _user$project$BoardViewer$model_advance = F2(
	function (m1, deltaRealTimeSeconds) {
		var _p60 = _user$project$BoardViewer$model_loadStreamedData(m1);
		var m2 = _p60._0;
		var canProcess = _p60._1;
...
var _user$project$BoardViewer$ERobotCollision = function (a) {
	return {ctor: 'ERobotCollision', _0: a};
};
var _user$project$BoardViewer$EExplosion = function (a) {
	return {ctor: 'EExplosion', _0: a};
};
var _user$project$BoardViewer$EMissile = function (a) {
	return {ctor: 'EMissile', _0: a};
};
var _user$project$BoardViewer$EScan = function (a) {
	return {ctor: 'EScan', _0: a};
};
var _user$project$BoardViewer$ERemoveRobot = function (a) {
	return {ctor: 'ERemoveRobot', _0: a};
};
var _user$project$BoardViewer$ECreateRobot = function (a) {
...
var _user$project$BoardViewer$boardEventVariantDecoder = function (eventType) {
	...
	switch (_p61) {
		...
		case 2:
			return A2(_elm_lang$core$Json_Decode$map, _user$project$BoardViewer$ERemoveRobot, _user$project$BoardViewer$eventRemoveRobotDecoder);
		case 3:
			return A2(_elm_lang$core$Json_Decode$map, _user$project$BoardViewer$EScan, _user$project$BoardViewer$eventScanDecoder);
		case 4:
			return A2(_elm_lang$core$Json_Decode$map, _user$project$BoardViewer$EMissile, _user$project$BoardViewer$eventMissileDecoder);
		case 5:
			return A2(_elm_lang$core$Json_Decode$map, _user$project$BoardViewer$EExplosion, _user$project$BoardViewer$eventExplosionDecoder);
		case 6:
			return A2(_elm_lang$core$Json_Decode$map, _user$project$BoardViewer$ERobotCollision, _user$project$BoardViewer$eventRobotCollisionDecoder);
		case 7:
			return A2(_elm_lang$core$Json_Decode$map, _user$project$BoardViewer$EDrive, _user$project$BoardViewer$eventDriveDecoder);
		default:
			return _elm_lang$core$Native_Utils.crashCase(
				'BoardViewer',
				{
...
var _user$project$BoardViewer$boardEventDecoder = A3(
	_elm_lang$core$Json_Decode$object2,
	_user$project$BoardViewer$BoardEvent,
	A2(
		_elm_lang$core$Json_Decode$andThen,
		A2(_elm_lang$core$Json_Decode_ops[':='], 'eventType', _elm_lang$core$Json_Decode$int),
		_user$project$BoardViewer$boardEventVariantDecoder),
	A2(_elm_lang$core$Json_Decode_ops[':='], 'activationTime', _elm_lang$core$Json_Decode$float));
var _user$project$BoardViewer$boardInfoDecoder = A9(
	_elm_lang$core$Json_Decode$object8,
	_user$project$BoardViewer$BoardInfo,
	A2(_elm_lang$core$Json_Decode_ops[':='], 'maxBoardX', _elm_lang$core$Json_Decode$float),
	A2(_elm_lang$core$Json_Decode_ops[':='], 'maxBoardY', _elm_lang$core$Json_Decode$float),
	A2(_elm_lang$core$Json_Decode_ops[':='], 'streamDelay', _elm_lang$core$Json_Decode$float),
	A2(_elm_lang$core$Json_Decode_ops[':='], 'turnDeltaTime', _elm_lang$core$Json_Decode$float),
	A2(_elm_lang$core$Json_Decode_ops[':='], 'networkLatency', _elm_lang$core$Json_Decode$float),
	...
	A2(
		_elm_lang$core$Json_Decode_ops[':='],
		'events',
		_elm_lang$core$Json_Decode$list(_user$project$BoardViewer$boardEventDecoder)));
var _user$project$BoardViewer$Mdl = function (a) {
...
var _user$project$BoardViewer$MsgInitBoard = {ctor: 'MsgInitBoard'};
var _user$project$BoardViewer$init = function () {
	var askWindowSize = A3(
		_elm_lang$core$Task$perform,
		function (x) {
			return _user$project$BoardViewer$MsgWindowSize(
				{width: 0, height: 0});
		},
		function (s) {
			return _user$project$BoardViewer$MsgWindowSize(s);
		},
		_elm_lang$window$Window$size);
	var m = {
		...
		boardInfo: _elm_lang$core$Maybe$Nothing,
		streamedBoardInfo: _elm_lang$core$Dict$empty,
	...
	return {
		...
		_1: _elm_lang$core$Platform_Cmd$batch(
			_elm_lang$core$Native_List.fromArray(
				[
					_user$project$BoardViewer$cmd_make(_user$project$BoardViewer$MsgInitBoard),
					askWindowSize
				]))
	};
}();
var _user$project$BoardViewer$MsgFetchFail = function (a) {
	return {ctor: 'MsgFetchFail', _0: a};
};
var _user$project$BoardViewer$fetchBoardInfo = function (isInit) {
	var url = isInit ? '/board-info' : '/board-events';
	var onHttpError = function (err) {
		return _elm_lang$core$Basics$toString(err);
	};
	return A3(
		_elm_lang$core$Task$perform,
		_user$project$BoardViewer$MsgFetchFail,
		_user$project$BoardViewer$MsgStreamBoardInfo,
		A2(
			_elm_lang$core$Task$mapError,
			onHttpError,
			A2(_evancz$elm_http$Http$get, _user$project$BoardViewer$boardInfoDecoder, url)));
};
		...
		switch (_p63.ctor) {
			...
			case 'MsgStreamBoardInfo':
				...
				if (_p64 === false) {
					return {
						ctor: '_Tuple2',
						_0: A2(_user$project$BoardViewer$model_init, model1, _p65),
						_1: _user$project$BoardViewer$fetchBoardInfo(false)
					};
				} else {
					return {
						ctor: '_Tuple2',
						_0: A2(_user$project$BoardViewer$model_addStream, model1, _p65),
						_1: _user$project$BoardViewer$fetchBoardInfo(false)
					};
				}
			case 'MsgFetchFail':
			...
			case 'MsgAdvanceRealTime':
				var _p68 = _p63._0;
				var _p66 = model1.simulationIsStarted;
				if (_p66 === false) {
					var _p67 = model1.isInitializated;
					if (_p67 === true) {
						return {
							ctor: '_Tuple2',
							_0: _elm_lang$core$Native_Utils.update(
								model1,
								{streamingLeft: model1.streamingLeft - _p68}),
							_1: _elm_lang$core$Platform_Cmd$none
						};
					} else {
						return {
							...
							_0: _elm_lang$core$Native_Utils.update(
								model1,
								{preStreaming: model1.preStreaming + _p68}),
							_1: _elm_lang$core$Platform_Cmd$none
						};
					}
				} else {
					return {
						ctor: '_Tuple2',
						_0: A2(_user$project$BoardViewer$model_advance, model1, _p68),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				}
			case 'MsgWindowSize':
			...
			default:
				return A2(_debois$elm_mdl$Material$update, _p63._0, model1);
		}
	});
var _user$project$BoardViewer$MsgAdvanceRealTime = function (a) {
	return {ctor: 'MsgAdvanceRealTime', _0: a};
};
var _user$project$BoardViewer$subscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$batch(
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$animation_frame$AnimationFrame$diffs(
				function (time) {
					return _user$project$BoardViewer$MsgAdvanceRealTime(
...
var _user$project$BoardViewer$main = {
	main: _elm_lang$html$Html_App$program(
		{init: _user$project$BoardViewer$init, update: _user$project$BoardViewer$update, subscriptions: _user$project$BoardViewer$subscriptions, view: _user$project$BoardViewer$view})
};

var Elm = {};
Elm['BoardViewer'] = Elm['BoardViewer'] || {};
_elm_lang$core$Native_Platform.addPublicModule(Elm['BoardViewer'], 'BoardViewer', typeof _user$project$BoardViewer$main === 'undefined' ? null : _user$project$BoardViewer$main);
